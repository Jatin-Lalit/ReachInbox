...
const base64url = require("base64url"); // Import base64url module
  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: "https://reachinbox-qhse.onrender.com/auth/google/callback",
    },
...
const oauth2Client = new google.auth.OAuth2(
  ...
  "https://reachinbox-qhse.onrender.com/auth/google/callback"
);
...
// Add a function to categorize email
...
// Modify the /api/emails endpoint to categorize emails
...
async function sendAutomatedReply(toEmail, subject, body) {
  ...
  const rawMessage = [
    `From: ${app.locals.user.profile.emails[0].value}`, // Use actual sender email address
    `To: ${toEmail}`,
    `Subject: Re: ${subject}`,
